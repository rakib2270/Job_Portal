...
@section('main')
    <section class="section-0 lazy d-flex bg-image-style dark align-items-center "  class="" data-bg="{{ asset('assets/images/banner3.jpg') }}">
        <div class="container">
            <div class="row">
                <div class="col-12 col-xl-8">
                    <h1>Jobs</h1>
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sint saepe fugiat distinctio modi debitis veniam officiis a sed itaque.</p>
                </div>
            </div>
        </div>
    </section>
