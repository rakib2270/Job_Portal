    ...
    <tr>
        ...
        <td bgcolor="#FFFFFF" style="border: 1px solid #eeeeee; background-color: #ffffff; border-radius:5px; display:block!important; max-width:600px!important; margin:0 auto!important; clear:both!important;"><div style="padding:20px; max-width:600px; margin:0 auto; display:block;">
                <table style="width: 100%;">
                    <tr>
                        <td><p style="text-align: center; display: block;  padding-bottom:20px;  margin-bottom:20px; border-bottom:1px solid #dddddd;"><img src="{{asset("public/assets/images/jobpulse.png")}}"/></p>
                            <h1 style="font-weight: 200; font-size: 36px; margin: 20px 0 30px 0; color: #333333;">Job Pulse</h1>
...
{{--                            <h2 style="font-weight: 200; font-size: 16px; margin: 20px 0; color: #333333;">Subject : {{$subject}} </h2>--}}
{{--                            <h2 style="font-weight: 200; font-size: 16px; margin: 20px 0; color: #333333;">Message : {{$message}} </h2>--}}
                            <p style="text-align: center; display: block; padding-top:20px; font-weight: bold; margin-top:30px; color: #666666; border-top:1px solid #dddddd;">www.jubpulse.com</p></td>
                    </tr>
                </table>
            </div></td>
        <td></td>
